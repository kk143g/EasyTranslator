...
public protocol Configuration {
    var shouldShowLanguages: Bool { get set }
    var countryNameTextColor: UIColor { get set }
    var countryNameTextFont: UIFont { get set }
    var countryDescriptionTextFont: UIFont { get set }
    ...
    var languagesAlreadyAdded: [SupportedLanguage] { get set }
}

public struct Config: Configuration {
    /// language names display
    public var shouldShowLanguages: Bool
    ...
    /// font of countryDescriptionTextFont
    public var countryDescriptionTextFont: UIFont
    ...
    /// Languages that already added
    public var languagesAlreadyAdded: [SupportedLanguage]

    public init(
        shouldShowLanguages: Bool = false,
        countryNameTextColor: UIColor = ColorCompatibility.label,
        countryNameTextFont: UIFont = UIFont.systemFont(ofSize: 16),
        countryDescriptionTextFont: UIFont = UIFont.systemFont(ofSize: 13),
        ...
        languagesAlreadyAdded: [SupportedLanguage] = []
    ) {
        self.shouldShowLanguages = shouldShowLanguages
        self.countryNameTextColor = countryNameTextColor
        self.countryNameTextFont = countryNameTextFont
        self.countryDescriptionTextFont = countryDescriptionTextFont
        ...
        self.languagesAlreadyAdded = languagesAlreadyAdded
    }
}
